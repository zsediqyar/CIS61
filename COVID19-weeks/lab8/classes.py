...
class Card(object):
    ...
    def power(self, other_card):
        ...
        """
        "*** YOUR CODE HERE ***"
        card_attack = self.attack
        card_defense = other_card.defense
        result = card_attack - card_defense / 2
        return result
...
class Player(object):
    def __init__(self, deck, name):
        ...
        self.name = name
        "*** YOUR CODE HERE ***"
        self.hand = [self.deck.cards.pop() for _ in range(0, 5)]
...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        "*** YOUR CODE HERE ***"
        p_attack = other_card.attack
        p_defense = other_card.defense
        for player_deck_card in player.deck.cards:
            player_deck_card.attack += p_attack
            player_deck_card.defense += p_defense
        opponent.deck.card = [
            card for card in opponent.deck.cards if not card.attack == p_attack and card.defense == p_defense]
