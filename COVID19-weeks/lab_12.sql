...
CREATE TABLE sentences AS
  ...
  SELECT first || ' and ' || second || ' are ' || a.size || ' siblings' AS sentence FROM siblings, size_of_dogs AS a, size_of_dogs as b WHERE first = a.name AND second = b.name AND a.size = b.size;
